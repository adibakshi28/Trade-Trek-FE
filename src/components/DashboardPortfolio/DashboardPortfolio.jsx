// src/pages/DashboardPortfolio.jsx
...
function DashboardPortfolio() {
  ...
  // Subscribe to portfolio updates when Dashboard Portfolio mounts
  useEffect(() => {
    // Send subscription message
    sendMessage({ type: 'subscribe_portfolio_watchlist' });
    console.log('📥 Sent subscribe_portfolio_watchlist message');

    // Cleanup function to unsubscribe when Dashboard Portfolio unmounts
    return () => {
